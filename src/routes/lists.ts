...
router.post('/:listId/share/:collaboratorId', authMiddleware.isAuthenticated, listController.addCollaborator); 		// POST /lists/:listId/collaborators/:collaboratorId
router.delete('/:listId/share/:collaboratorId', authMiddleware.isAuthenticated, listController.removeCollaborator); // DELETE /lists/:listId/collaborators/:collaboratorId
